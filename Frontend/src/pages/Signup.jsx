...
import { Eye, EyeOff, Loader2, Lock, LucideMessagesSquare, Mail, User } from "lucide-react";
...
const Signup = () => {
  ...
  return (
    <>
      <div className="h-screen grid dark:bg-slate-800">
        {/* left side  */}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="form-control">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className={`input input-bordered w-full pl-10 focus:outline-none dark:bg-gray-800`}
